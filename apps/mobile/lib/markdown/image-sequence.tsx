/**
 * Screen-scoped image sequence for the lightbox (ISS-5752).
 *
 ...
 * clients call `collectImageSequence` from @orchestra/core so an issue's images
...
} from "@orchestra/core/attachments/image-sequence";
