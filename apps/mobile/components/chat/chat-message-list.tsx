...
export function ChatMessageList({
  ...
  // Every image in this session, in message order (ISS-5752), so tapping one
...
function MessageRow({
  ...
  if (isUser) {
    ...
    // serialisation `[ISS-1](mention://issue/<id>)`, inline links, and
...
function AssistantRow({
  ...
  // no_response (ISS-4351, mirrors packages/views AssistantMessage): the agent
