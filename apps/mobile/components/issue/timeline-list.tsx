...
import type { Issue, TimelineEntry } from "@orchestra/core/types";
...
import type { ImageSequenceBlock } from "@orchestra/core/attachments/image-sequence";
...
export function TimelineList({
  ...
  // each comment row with its replies (ISS-5752). Tapping any of them opens
