 ...
 * yet schematised in @orchestra/core/api/schemas. Lenient by design — see the
...
import { IssueSchema } from "@orchestra/core/api/schemas";
...
export const AgentSchema: z.ZodType<Agent> = z.object({
  ...
  // ISS-2600: agent resource shape no longer carries custom_env or
...
// availability derivation in @orchestra/core/agents/derive-presence. All other
...
// Crew schema — fields mobile actually consumes for the @mention suggestion
// bar (id, name, archived_at filter) plus identity/timestamp fields that are
// safe to default. `.loose()` so the server can add crew fields without
// breaking the parser.
export const CrewSchema: z.ZodType<Crew> = z.object({
  id: z.string(),
  workspace_id: z.string().default(""),
  name: z.string().default(""),
  description: z.string().default(""),
...
export const CrewListSchema = z.array(CrewSchema).default([]);
...
export const EMPTY_ISSUE_FALLBACK: import("@orchestra/core/types").Issue = {
  id: "",
  workspace_id: "",
  number: 0,
  identifier: "",
