 ...
 *
 * Types are imported via `import type` from @orchestra/core/types — zero
 * runtime coupling. Zod schemas + fallbacks are imported from
 * @orchestra/core/api/schemas (pure data, on the mobile sharing whitelist).
 *
...
} from "@orchestra/core/api/schemas";
import {
...
class ApiClient {
  ...
  async listCrews(opts?: { signal?: AbortSignal }): Promise<Crew[]> {
