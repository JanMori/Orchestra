 ...
 * `@orchestra/core/issues/stores/issues-scope-store` — mobile only
 * `import type` from `@orchestra/core/types/*` per Sharing Principles, and
...
import type { IssuePriority, IssueStatus } from "@orchestra/core/types";
