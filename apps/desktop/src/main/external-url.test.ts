...
describe("isSafeExternalHttpUrl", () => {
  it("allows http and https URLs", () => {
    expect(isSafeExternalHttpUrl("http://localhost:5001")).toBe(true);
...
describe("openExternalSafely", () => {
  ...
  it("forwards http/https URLs to shell.openExternal", () => {
    openExternalSafely("http://localhost:5001");
    expect(shell.openExternal).toHaveBeenCalledWith("http://localhost:5001");
  });
