/**
 * Two regressions are pinned here, both found in review of ISS-5345.
 *
 ...
 *    is precisely the ISS-4115 failure the ack protocol exists to prevent.
...
describe("telemetry props carry no raw identifiers", () => {
  ...
  // ISS-5345: stack capture is gone, but a machine upgrading from v0.4.13–
