...
import { ProjectsPage } from "@orchestra/views/projects/components";
import { DashboardPage } from "@orchestra/views/dashboard";
import { AutopilotsPage } from "@orchestra/views/autopilots/components";
import { MyIssuesPage } from "@orchestra/views/my-issues";
import { SkillsPage } from "@orchestra/views/skills";
    ...
    children: [
      { index: true, element: null },
      {
        ...
        children: [
          ...
          // safety net instead of an in-router <Navigate> (ISS-4741
...
/**
 * Create THE app router (ISS-4741 single-router session architecture).
