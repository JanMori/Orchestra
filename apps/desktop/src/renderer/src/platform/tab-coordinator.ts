...
import type { ScrollRestorationAdapter } from "@orchestra/views/platform";
...
/**
 * Tab Coordinator (ISS-4741 Phase 2) — the ONLY writer of the single app
 * router.
 *
 ...
 * see ScrollRestorationProvider in @orchestra/views/platform). Offsets are
