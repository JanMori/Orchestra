...
export function createZhDict(allowSignup: boolean): LandingDict {
  ...
  hero: {
    ...
    headlineLine2: "\u4e0d\u662f\u4eba\u7c7b\u3002",
    subheading:
      "Orchestra \u662f\u4e00\u4e2a\u5f00\u6e90\u5e73\u53f0\uff0c\u5c06\u7f16\u7801 智能体 \u53d8\u6210\u771f\u6b63\u7684\u961f\u53cb\u3002\u5206\u914d\u4efb\u52a1\u3001\u8ddf\u8e2a\u8fdb\u5ea6\u3001\u79ef\u7d2f\u6280\u80fd\u2014\u2014\u5728\u4e00\u4e2a\u5730\u65b9\u7ba1\u7406\u4f60\u7684\u4eba\u7c7b + 智能体 \u56e2\u961f\u3002",
    cta: "免费开始",
    downloadDesktop: "下载桌面端",
    talkToSales: "联系商务",
    worksWith: "支持",
    imageAlt: "Orchestra \u770b\u677f\u89c6\u56fe\u2014\u2014\u4eba\u7c7b\u548c 智能体 \u534f\u540c\u7ba1\u7406\u4efb\u52a1",
  },
    ...
    runtimes: {
      ...
      cards: [
        ...
        },
        {
          title: "\u9996\u6b21\u542f\u52a8\u81ea\u52a8\u6ce8\u518c",
          description:
            "Orchestra \u626b\u63cf\u672c\u673a\u7684 15 \u6b3e\u652f\u6301\u7684 AI \u7f16\u7a0b\u5de5\u5177\u2014\u2014Antigravity\u3001Claude Code\u3001CodeBuddy\u3001Codex\u3001Cursor\u3001Copilot\u3001Hermes\u3001Kimi\u3001Reasonix\u3001Kiro CLI\u3001OpenCode\u3001OpenClaw\u3001Pi\u3001Qoder\u3001Trae CLI\u2014\u2014\u5e76\u4e3a\u6bcf\u6b3e\u5df2\u5b89\u88c5\u7684\u5de5\u5177\u6ce8\u518c\u4e00\u4e2a\u8fd0\u884c\u65f6\u3002",
        },
      ],
    },
  },
  ...
  howItWorks: {
    ...
    steps: [
      ...
      },
      {
        ...
        description:
          "运行 orchestra setup——它会引导你完成 OAuth 登录、启动守护进程、并扫描 15 款支持的 AI 编程工具（Antigravity、Claude Code、CodeBuddy、Codex、Cursor、Copilot、Hermes、Kimi、Reasonix、Kiro CLI、OpenCode、OpenClaw、Pi、Qoder、Trae CLI）。本机已安装的工具会被自动注册成运行时。",
      },
      {
        title: "\u521b\u5efa\u4f60\u7684\u7b2c\u4e00\u4e2a 智能体",
        description:
  ...
  openSource: {
    ...
    headlineLine2: "\u4e3a\u6240\u6709\u4eba\u3002",
    description:
      "Orchestra \u5b8c\u5168\u5f00\u6e90\u3002\u5ba1\u67e5\u6bcf\u4e00\u884c\u4ee3\u7801\uff0c\u6309\u4f60\u7684\u65b9\u5f0f\u81ea\u6258\u7ba1\uff0c\u5851\u9020\u4eba\u7c7b + 智能体 \u534f\u4f5c\u7684\u672a\u6765\u3002",
    cta: "\u5728 GitHub \u4e0a Star",
    highlights: [
      {
        title: "\u968f\u5904\u81ea\u6258\u7ba1",
        description:
          "\u5728\u4f60\u81ea\u5df1\u7684\u57fa\u7840\u8bbe\u65bd\u4e0a\u8fd0\u884c Orchestra\u3002Docker Compose\u3001\u5355\u4e2a\u4e8c\u8fdb\u5236\u6216 Kubernetes\u2014\u2014\u4f60\u7684\u6570\u636e\u6c38\u8fdc\u4e0d\u4f1a\u79bb\u5f00\u4f60\u7684\u7f51\u7edc\u3002",
      },
      {
        title: "\u65e0\u4f9b\u5e94\u5546\u9501\u5b9a",
        description:
  ...
  faq: {
    ...
    items: [
      {
        question: "Orchestra \u652f\u6301\u54ea\u4e9b\u7f16\u7801 智能体\uff1f",
        answer:
          "Orchestra \u5f00\u7bb1\u5373\u7528\u652f\u6301 15 \u6b3e AI \u7f16\u7a0b\u5de5\u5177\uff1aAntigravity\u3001Claude Code\u3001CodeBuddy\u3001Codex\u3001Cursor\u3001Copilot\u3001Hermes\u3001Kimi\u3001Reasonix\u3001Kiro CLI\u3001OpenCode\u3001OpenClaw\u3001Pi\u3001Qoder\u3001Trae CLI\u3002\u5b88\u62a4\u8fdb\u7a0b\u4f1a\u81ea\u52a8\u68c0\u6d4b\u672c\u673a\u5df2\u5b89\u88c5\u7684 CLI \u5e76\u4e3a\u6bcf\u6b3e\u6ce8\u518c\u4e00\u4e2a\u8fd0\u884c\u65f6\u3002\u56e0\u4e3a\u5f00\u6e90\uff0c\u4f60\u4e5f\u53ef\u4ee5\u81ea\u5df1\u6dfb\u52a0\u540e\u7aef\u3002",
      },
      {
        question: "\u9700\u8981\u81ea\u6258\u7ba1\u5417\uff0c\u8fd8\u662f\u6709\u4e91\u7248\u672c\uff1f",
        answer:
          "\u4e24\u8005\u90fd\u6709\u3002\u4f60\u53ef\u4ee5\u7528 Docker Compose \u6216 Kubernetes \u5728\u81ea\u5df1\u7684\u57fa\u7840\u8bbe\u65bd\u4e0a\u81ea\u6258\u7ba1 Orchestra\uff0c\u4e5f\u53ef\u4ee5\u4f7f\u7528\u6211\u4eec\u7684\u6258\u7ba1\u4e91\u7248\u672c\u3002\u4f60\u7684\u6570\u636e\uff0c\u4f60\u9009\u62e9\u3002",
      },
      {
        question:
          "\u8fd9\u548c\u76f4\u63a5\u7528\u7f16\u7801 智能体 \u6709\u4ec0\u4e48\u533a\u522b\uff1f",
        answer:
          "\u7f16\u7801 智能体 \u64c5\u957f\u6267\u884c\u3002Orchestra \u6dfb\u52a0\u7684\u662f\u7ba1\u7406\u5c42\uff1a\u4efb\u52a1\u961f\u5217\u3001\u56e2\u961f\u534f\u4f5c\u3001\u6280\u80fd\u590d\u7528\u3001\u8fd0\u884c\u65f6\u76d1\u63a7\uff0c\u4ee5\u53ca\u6bcf\u4e2a 智能体 \u5728\u505a\u4ec0\u4e48\u7684\u7edf\u4e00\u89c6\u56fe\u3002\u628a\u5b83\u60f3\u8c61\u6210\u4f60\u7684 智能体 \u7684\u9879\u76ee\u7ecf\u7406\u3002",
      },
      {
        question: "智能体 \u80fd\u81ea\u4e3b\u5904\u7406\u957f\u65f6\u95f4\u4efb\u52a1\u5417\uff1f",
        answer:
          "\u53ef\u4ee5\u3002Orchestra \u7ba1\u7406\u5b8c\u6574\u7684\u4efb\u52a1\u751f\u547d\u5468\u671f\u2014\u2014\u5165\u961f\u3001\u9886\u53d6\u3001\u6267\u884c\u3001\u5b8c\u6210\u6216\u5931\u8d25\u3002智能体 \u4e3b\u52a8\u62a5\u544a\u963b\u585e\u5e76\u5b9e\u65f6\u63a8\u9001\u8fdb\u5ea6\u3002\u4f60\u53ef\u4ee5\u968f\u65f6\u67e5\u770b\uff0c\u4e5f\u53ef\u4ee5\u8ba9\u5b83\u4eec\u8fd0\u884c\u6574\u665a\u3002",
      },
      {
        question: "\u6211\u7684\u4ee3\u7801\u5b89\u5168\u5417\uff1f智能体 \u5728\u54ea\u91cc\u6267\u884c\uff1f",
        answer:
          "智能体 \u5728\u4f60\u7684\u673a\u5668\uff08\u672c\u5730\u5b88\u62a4\u8fdb\u7a0b\uff09\u6216\u4f60\u81ea\u5df1\u7684\u4e91\u57fa\u7840\u8bbe\u65bd\u4e0a\u6267\u884c\u3002\u4ee3\u7801\u6c38\u8fdc\u4e0d\u4f1a\u7ecf\u8fc7 Orchestra \u670d\u52a1\u5668\u3002\u5e73\u53f0\u53ea\u534f\u8c03\u4efb\u52a1\u72b6\u6001\u548c\u5e7f\u64ad\u4e8b\u4ef6\u3002",
      },
      {
  ...
  footer: {
    ...
    copyright: "\u00a9 {year} Orchestra. \u4fdd\u7559\u6240\u6709\u6743\u5229\u3002",
  },
  ...
  about: {
    ...
    paragraphs: [
      ...
      "在 Orchestra 中，agents 是一级团队成员。它们会被分配任务，汇报进展，提出阻塞，并交付代码，就像人类同事一样。任务分配、活动时间线、task 生命周期，以及运行时基础设施，Orchestra 从第一天起就是围绕这一理念构建的。",
    ...
    entries: [
      ...
      },
      {
        ...
        improvements: [
          ...
          "工作区很多时，Orchestra 启动不再反复检查智能体工具。",
      ...
      },
      {
        version: "0.3.41",
        date: "2026-07-08",
        title: "机器命名、成员自建小组与命令行排序任务",
        changes: [],
        features: [
          "你现在可以给机器起名字，创建智能体时的运行时选择器支持搜索并按机器分组。",
          "任何成员现在都能自己创建和管理小组，不再只有管理员可以。",
      ...
      },
      {
        version: "0.3.39",
        date: "2026-07-06",
        title: "Qoder 与 TRAE CLI 加入自定义运行时基座，小组与稳定性修复",
        changes: [],
        features: [
        ...
        fixes: [
          "多阶段小组流程在私有 Leader + 子任务由智能体关闭的情况下，不再卡在第一阶段。",
          "父任务的「子任务完成」提示不再把中间阶段错说成最终阶段，小组 Leader 可以自己选择继续下一阶段还是收尾。",
          "小组 Leader 在收尾阶段不再占用本地仓库的锁，同一个仓库里的多个智能体可以继续并行工作。",
      ...
      },
      {
        ...
        features: [
          ...
          "自托管（Helm）：新增 `postgres.external.enabled` 开关，可将 Orchestra 指向外部托管的 PostgreSQL（RDS、CNPG、Cloud SQL、Neon 等），跳过内置数据库。",
        ],
        fixes: [
          ...
          "`/crews/…` 与 `/usage` 老路径不再 404，会重定向到当前对应页面。",
          "桌面端「保存」对话框展示真实的附件文件名，不再默认成 `download.txt`。（社区贡献）",
          "小组协作：Leader 通过 mention 派发的工作者智能体，在通过 HTTP API 发布完成评论时，能正确唤醒私有小组 Leader；Leader → Worker → Leader 协作链不再在第一跳后卡住。",
      ...
      },
      {
        ...
        fixes: [
          "同一小组里子任务完成时，父任务所属小组的 Leader 会被叫醒，父任务不再滞留处理中。",
      ...
      },
      {
        ...
        changes: [],
        features: [
          "Slack 里可以直接用原生 /issue 斜杠命令创建 Orchestra 任务，机器人只会向你私发一条包含任务链接的确认消息。",
          "同一 Slack 工作区里已经和某个 Orchestra 机器人绑定过的用户，遇到新加入的第二个机器人时无需再走一次绑定流程。",
        ...
        fixes: [
          ...
          "自托管的 docker-compose.selfhost.yml 现在会把 ORCHESTRA_SLACK_SECRET_KEY 透传到后端容器。（社区反馈）",
          "任务面板顶部「N 个任务正在处理中」的胶囊改为按任务数去重。",
          "自托管匿名来源统计的上报地址恢复到正式的 Orchestra API。",
      ...
      },
      {
        ...
        features: [
          ...
          "Slack 频道可以把过往对话回灌到 Orchestra，智能体一进入频道即拥有完整上下文。",
          "Slack 智能体处理消息期间会在用户消息上加 👀 反应表情，处理结束后稳定清除，不再出现卡死。",
          "技能包支持从本地 .skill / .zip 归档导入。",
          "orchestra issue 命令不再接受短 UUID 前缀，请使用任务 Key（TASK-123）或完整 UUID。",
          "Agents 页面适配移动端。",
        ],
        improvements: [
          "重写了评论路由级联：父链 @ 提及、智能体署名回复、小组 Leader 兜底，三条路径汇入同一条经过充分测试的流程。",
      ...
      },
      {
        ...
        fixes: [
          ...
          "通过 @ 提及让小组 Leader 接手时，会带上完整的小组 Briefing；继承父级提及的回复也不会再次触发 Leader。",
      ...
      },
      {
        ...
        features: [
          ...
          "小组负责人现在可以在成员列表里看到成员技能，分配任务时更容易选对人",
      ...
      },
      {
        ...
        fixes: [
          "回复和编辑评论前，现在会更准确地预览哪些智能体或小组会开始运行",
      ...
      },
      {
        ...
        changes: [],
        features: [
          "智能体、自动任务、项目、运行环境、技能和小组的列表体验更快也更一致，行内容、筛选、选择和操作都更清楚",
          "命令行现在可以管理工作区仓库，本地智能体更容易拿到项目仓库上下文",
          "Cursor 和 OpenClaw 更容易配置：Cursor 连接设置可以由 Orchestra 托管，OpenClaw 也可以连接已有网关",
          "编辑评论时，可以在保存前预览并控制哪些智能体或小组会开始运行",
        ],
        improvements: [
      ...
      },
      {
        ...
        changes: [],
        features: [
          "CodeBuddy 现在可以驱动本地 Orchestra 智能体，并会自动显示可用的模型和投入强度选项",
      ...
      },
      {
        ...
        changes: [],
        features: [
          "评论输入框现在会在发送前显示哪些智能体或小组会开始工作，也可以避免误触发运行",
          "智能体运行记录现在会显示时间点，回看进度和交接信息更清楚",
          "自动任务详情页现在会显示创建人",
          "Claude Fable 5 现在已加入 Orchestra 支持的模型和价格列表",
          "任务讨论可以把某一条回复设为解决结论，长讨论收起后也能直接看到最终答案",
          "在 Lark 和飞书里和 Orchestra 对话时，会显示等待中的输入状态，回复发出后自动清除",
          "每次智能体 task 都会带上真实发起人信息，交接、审计和权限判断更准确",
          "OpenClaw 可以从本地配置中读取自定义程序位置和数据目录",
        ],
        improvements: [
          "评论触发提示更安静、更清楚，遇到较长的智能体名称时也不容易拥挤",
          "桌面端在守护进程由 Orchestra 之外的环境管理时，会禁用启动和停止控制，例如 WSL2 场景",
      ...
      },
      {
        ...
        changes: [],
        features: [
          "网页端现在可以显示浏览器原生通知横幅，即使 Orchestra 在后台，也更容易及时看到工作区动态",
        ...
        fixes: [
          ...
          "删除运行时时，现在会在同一套清理流程里处理已归档小组并暂停自动任务",
      ...
      },
      {
        ...
        changes: [],
        features: [
          "支持 Lark 第三方集成，扫码就能把 Orchestra 智能体创建成一个 Lark Bot",
          "聊天现在支持可搜索的智能体选择器和明确的上下文选择器，更容易指定谁来回复、需要看哪些内容",
          "描述和评论现在支持勾选式待办清单，任务里的轻量计划更好整理",
          "智能体现在内置 Orchestra 技能，可以更稳定地遵循工作区工作流",
        ],
        improvements: [
      ...
      },
      {
        ...
        features: [
          ...
          "Orchestra 现在支持韩语界面、官网和文档，包含完整韩语文档与本地化日期显示",
        ...
        improvements: [
          "详情页统一了面包屑导航，任务、项目、运行环境、技能、智能体和小组的返回路径更清楚",
      ...
      },
      {
        ...
        improvements: [
          ...
          "命令行列表输出对自动化读取更安静，小组列表也会显示可用的成员数量",
        ],
        fixes: [
      ...
      },
      {
        ...
        changes: [],
        features: [
          "Orchestra iOS 客户端发布官方首个可用版本，覆盖登录、工作区、收件箱、任务、项目、聊天、评论、表情回应、在线状态和实时更新；目前暂未上架 App Store，需要用户自行打包安装",
          "自托管团队现在可以通过 Helm 将 Orchestra 部署到 Kubernetes，Docker 安装也有更清晰的端口和 URL 配置",
        ...
        improvements: [
          "小组头像和看板卡片会显示更完整的悬浮信息、成员状态和实时工作状态",
      ...
      },
      {
        ...
        features: [
          ...
          "新用户完成设置后，会进入由 Orchestra Helper 引导的欢迎体验",
      ...
      },
      {
        ...
        changes: [],
        features: [
          "自动任务现在可以通过小组分配工作，并把创建的任务直接归入指定项目",
      ...
      },
      {
        ...
        improvements: [
          ...
          "关联 GitHub 的 Pull Request 会在 Orchestra 内展示 CI 和合并冲突状态",
        ...
        fixes: [
          ...
          "Crew 页面可以正常滚动，并能看到成员当前是否已经在处理工作",
          "桌面端缩放快捷键在常见组合下恢复正常",
      ...
      },
      {
        ...
        changes: [],
        features: [
          "Crews 支持把任务交给一个小组，由 leader agent 负责协调下一步",
          "附件可以直接预览，支持 PDF、音频、视频、Markdown、代码、日志和纯文本",
          "中文姓名支持用拼音搜索，适用于 mention、负责人、订阅人、agents、projects 和 crews",
        ],
        improvements: [
          "Crew 页面补齐成员管理、从 crew 内快速创建 agent、清晰的成员操作按钮，以及更宽的详情布局",
          "快速创建和各类选择器更容易搜索，并能识别 crew 相关的指派和提及",
          "Usage 图表可以在费用和 token 视图之间切换，并复用 runtime 的时区控制",
          "工作区管理员可以通过命令行管理 crews，并在必要时停止失控的 task",
          "共享界面文案的中英文翻译更完整",
        ],
        fixes: [
          "当成员已经明确把讨论指向某个人或小组时，Crew leader 不再重复发言",
          "提及 crew 时会正确唤起对应 leader，同时保留私有 agent 的访问限制",
      ...
      },
      {
        ...
        changes: [],
        features: [
          "接入 GitHub 后，关联的 Pull Request 会显示在 Orchestra 任务中，状态会同步到 Orchestra，关闭 PR 后会自动关闭对应任务",
          "聊天消息支持添加文件附件和图片预览",
        ...
        improvements: [
          ...
          "Linux 桌面端安装包恢复显示 Orchestra 应用图标",
        ],
        fixes: [
          "下载附件时保留原始文件名",
      ...
      },
      {
        ...
        fixes: [
          ...
          "Windows / Linux 桌面端用 Orchestra asterisk 替换 Electron 默认占位图标",
      ...
      },
      {
        ...
        changes: [],
        features: [
          "`orchestra repo checkout --ref` 支持按分支、tag 或指定 commit 拉取仓库",
          "`orchestra agent avatar` 命令支持直接通过 CLI 上传 Agent 头像",
        ...
        fixes: [
          ...
          "`orchestra login --token <PAT>` 正确接收 PAT 作为参数值",
      ...
      },
      {
        ...
        improvements: [
          ...
          "Orchestra Agent 的 Git 提交自动追加 `Co-authored-by` trailer，归属更清晰",
      ...
      },
      {
        ...
        improvements: [
          ...
          "后端支持通过 `ORCHESTRA_CLAUDE_ARGS` / `ORCHESTRA_CODEX_ARGS` 配置 Agent CLI 默认参数",
      ...
      },
      {
        ...
        changes: [],
        features: [
          "`orchestra agent create/update --custom-env KEY=VALUE` 支持为 Agent 注入自定义环境变量",
      ...
      },
      {
        ...
        changes: [],
        features: [
          "Agent 新增 `model` 字段及按 Provider 聚合的模型下拉框——可在界面或通过 `orchestra agent create/update --model` 为每个 Agent 选择 LLM 模型，并从各 Runtime CLI 实时发现可用模型",
      ...
      },
      {
        ...
        changes: [],
        features: [
          "一键安装与配置——`curl | bash` 安装 CLI，`--with-server` 完整自部署，`orchestra setup` 配置连接环境",
      ...
      },
      {
        ...
        improvements: [
          ...
          "搜索排序优化——大小写无关匹配、标识符搜索（TASK-123）、多词匹配",
          "搜索结果关键词高亮",
      ...
      },
      {
        ...
        changes: [
          ...
          "重新登录后记住上次选择的工作区",
          "守护进程确保 Agent task 环境中 orchestra CLI 在 PATH 上",
  ...
  contactSales: {
    pageTitle: "联系商务",
    pageDescription:
      "了解如何在你的团队中落地 Orchestra 的人类 + 智能体协作工作流。",
    eyebrow: "联系商务",
    title: "先了解你的需求",
    ...
    fields: {
      ...
      companySize: "公司规模",
      countryRegion: "国家 / 地区",
      useCase: "你打算如何使用 Orchestra 或与我们合作？",
      goals: "你的目标或挑战",
      goalsHint:
        "告诉我们你希望借助 Orchestra 达成什么目标，或正在面临的挑战。信息越详细，我们越能给到合适的支持。",
    ...
    useCases: [
      { value: "evaluate", label: "正在为团队评估 Orchestra" },
    ...
    consent: {
      intro:
        "Orchestra, Inc. 尊重你的隐私。我们仅会将你的个人信息用于管理账户，以及提供你所请求的产品或服务。我们偶尔也希望与你分享产品更新、最佳实践或行业洞察，如果你愿意接收，请在下方勾选。",
      outreach:
        "我希望接收来自 Orchestra, Inc. 的一对一沟通，包括服务更新、支持咨询以及业务相关的跟进。",
      updates:
        "我希望接收 Orchestra 的产品更新、洞察以及活动邀请。",
      unsubscribe:
        "你可以随时取消订阅我们的邮件。关于我们如何处理你的数据以及隐私权利，请参阅",
      submitConsent:
        "点击「提交」即表示你同意 Orchestra, Inc. 存储并处理你提交的信息，以便交付你请求的内容。",
    ...
    success: {
      title: "已收到，谢谢！",
      message:
        "Orchestra 团队会在三个工作日内回复你。在此期间，欢迎查看我们的文档，或在 GitHub 上为我们点个 Star。",
      cta: "返回首页",
    },
    errors: {
      generic: "提交失败，请稍后再试。",
