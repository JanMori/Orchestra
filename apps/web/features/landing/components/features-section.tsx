...
import { StatusIcon, PriorityIcon } from "@orchestra/views/issues/components";
import { STATUS_CONFIG } from "@orchestra/core/issues/config/status";
import { PRIORITY_CONFIG } from "@orchestra/core/issues/config/priority";
import type { IssueStatus, IssuePriority } from "@orchestra/core/types";
    ...
    <div className="relative aspect-video overflow-hidden rounded-lg border bg-background text-foreground shadow-2xl">
      ...
      <div className="flex h-10 shrink-0 items-center border-b bg-background px-4 text-body">
        <div className="flex items-center gap-1.5 min-w-0 text-caption">
          ...
          <span className="text-muted-foreground">ISS-18</span>
          <ChevronRight className="h-3 w-3 text-faint-foreground shrink-0" />
