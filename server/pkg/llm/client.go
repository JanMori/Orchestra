...
type Config struct {
	// APIKey authenticates against the upstream. Maps to ORCHESTRA_LLM_API_KEY.
	APIKey string
	...
	// ORCHESTRA_LLM_BASE_URL.
	BaseURL string
	// DefaultModel is used when a request omits the model. Maps to
	// ORCHESTRA_LLM_DEFAULT_MODEL. When empty, FallbackModel is used.
	DefaultModel string
