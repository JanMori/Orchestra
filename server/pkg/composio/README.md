...
not import any other Orchestra package, so it can be reused by other services or
...
import (
    ...
    "github.com/JanMori/Orchestra/server/pkg/composio"
)
...
link, err := client.CreateLink(ctx, composio.CreateLinkRequest{
    ...
    UserID:       orchestraUserID.String(), // your own user id
    CallbackURL:  "http://localhost:5001/api/integrations/composio/callback",
})
...
- **Standalone.** Zero coupling to Orchestra internals — depend on this package
