...
// ISS-2416: OpenCode resolves its AGENTS.md walk-up and .opencode/skills
...
// TestOpencodeBackendNeverEmitsPromptFlag pins ISS-5392: `opencode run` has no
...
// override it would re-introduce the ISS-2416 regression.
