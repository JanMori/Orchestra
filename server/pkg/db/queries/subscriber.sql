...
--     sticks on a tree an agent keeps adding to (ISS-5483).
--
...
-- The delegated rule's write (ISS-5483). Eligibility and insert are ONE
...
-- as the member-row delete (ISS-5483 review round 7).
--
