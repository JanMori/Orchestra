...
// `issue create` path produces (ISS-4305).
...
// TestDelegatedSubscribe_AgentCreatedSubIssue is ISS-5483's headline case. Every
...
// ISS-5483 thread), and the tree-level signal comes from the parent's own status
