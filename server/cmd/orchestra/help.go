...
var rootHelpTemplate = `Work seamlessly with Orchestra from the command line.

USAGE
  orchestra <command> <subcommand> [flags]
{{range .Groups}}
{{.Title}}
...
EXAMPLES
  ...
  $ orchestra agent list --output json
...
LEARN MORE
  Use ` + "`orchestra <command> <subcommand> --help`" + ` for more information about a command.
`
