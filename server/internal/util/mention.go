...
// The @ prefix is optional to support issue mentions which use [TASK-123](mention://issue/...).
...
var MentionRe = regexp.MustCompile(`\[@?(.+?)\]\(mention://(member|agent|crew|issue|all)/([0-9a-fA-F-]+|all)\)`)
