...
var legacyDuplicateMigrationStems = map[string][]string{
	...
	"084": {"084_crew", "084_task_usage_dashboard_rollup"},
	...
	"096": {"096_autopilot_crew_assignee", "096_pending_check_suite", "096_user_profile_description"},
	...
	"127": {"127_issue_pull_request_reference_only", "127_task_crew_id", "127_user_composio_connection"},
