...
// TestEnrichRecentContextGroupMention is the ISS-3084 core: a bare @-bot
...
// TestEnrichRecentContextResolvesNames covers the ISS-3084 follow-up:
...
//
// It also pins the ISS-3084 review fix: the quoted parent's sender
