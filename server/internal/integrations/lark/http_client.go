...
const (
	...
	// Operators do NOT set ORCHESTRA_LARK_HTTP_BASE_URL to pick a cloud
...
func (c HTTPClientConfig) withDefaults() HTTPClientConfig {
	...
	// non-empty BaseURL (ORCHESTRA_LARK_HTTP_BASE_URL, or an httptest URL
...
// cfg.BaseURL (ORCHESTRA_LARK_HTTP_BASE_URL, or an httptest URL in tests)
...
// inverse across WS perspectives — see ISS-2671 triage), so we
