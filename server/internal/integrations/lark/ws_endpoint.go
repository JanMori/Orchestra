...
// ORCHESTRA_LARK_CALLBACK_BASE_URL still overrides every installation when
// set (staging / mock).
...
//
// PersonalAgent compatibility — OPEN RISK (ISS-2671 review thread):
...
func (c HTTPConnectionTokenConfig) withDefaults() HTTPConnectionTokenConfig {
	...
	// (ORCHESTRA_LARK_CALLBACK_BASE_URL, or an httptest URL in tests)
