...
//
// Background (GH #5544, ISS-4302, ISS-4897). Migration 197 installs the
...
// a preMigrationHook mechanism (used for migration 103, ISS-2957) that runs
...
// accountable_user_id MUST equal originator_user_id (ISS-4302 §1/§11).
