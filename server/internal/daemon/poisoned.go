...
//
// ISS-2946: ReasonIterationLimit and ReasonAPIInvalidRequest are aliased
...
// ISS-1630). The cap intentionally errs on the side of NOT classifying
...
// into a permanent stall (ISS-5722).
//
