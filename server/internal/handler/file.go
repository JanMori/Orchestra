...
type AttachmentResponse struct {
	...
	// ORCHESTRA_LOCAL_UPLOAD_BASE_URL), and otherwise prefixing
	// ORCHESTRA_PUBLIC_URL onto the stable per-attachment endpoint that the
...
//     proxies on every request, anchored on `ORCHESTRA_PUBLIC_URL` so the
