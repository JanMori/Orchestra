...
func TestUpdateMeAcceptsLanguage(t *testing.T) {
	userID := newLanguageTestUser(t, "lang-set@orchestra.local")
...
func TestUpdateMeAcceptsKoreanLanguage(t *testing.T) {
	userID := newLanguageTestUser(t, "lang-ko@orchestra.local")
...
func TestUpdateMeAcceptsJapaneseLanguage(t *testing.T) {
	userID := newLanguageTestUser(t, "lang-ja@orchestra.local")
...
func TestUpdateMeRejectsUnsupportedLanguage(t *testing.T) {
	userID := newLanguageTestUser(t, "lang-reject@orchestra.local")
...
func TestUpdateMePreservesLanguageWhenNotProvided(t *testing.T) {
	userID := newLanguageTestUser(t, "lang-preserve@orchestra.local")
