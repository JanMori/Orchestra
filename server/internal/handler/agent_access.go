...
// canEnqueueCrewLeader returns true when the given actor is allowed to
// trigger the crew's private leader. It loads the leader agent and delegates
...
func (h *Handler) canEnqueueCrewLeader(ctx context.Context, leaderID pgtype.UUID, actorType, actorID, originatorUserID, workspaceID string) bool {
