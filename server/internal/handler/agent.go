...
type AgentTaskResponse struct {
	...
	ParentIssueIdentifier    string                 `json:"parent_issue_identifier,omitempty"`     // human-readable identifier (e.g. TASK-123) of the quick-create parent issue, resolved on claim for prompt context
	...
	// ORCHESTRA_TOKEN in the agent process environment. The server binds it to
