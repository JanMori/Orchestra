...
type CloudFrontSigner struct {
	...
	domain       string // CDN domain, e.g. "static.localhost:5001"
	cookieDomain string // cookie scope, e.g. ".localhost:5001"
}
...
//   - CLOUDFRONT_DOMAIN       (e.g. "static.localhost:5001")
//   - COOKIE_DOMAIN           (e.g. ".localhost:5001")
