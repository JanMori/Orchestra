...
-- set from ISS-961 (slug review follow-up).
--
...
--
-- Per db-boy's prod audit (ISS-961 thread, 2026-04-22), two slugs in the §3
...
--
-- Decision on ISS-961: force-rename both via this migration (scheme 1), same
-- playbook as ISS-972 for admin/multica/new/www. Rename targets `home-1`
