 ...
 * preview viewer's prev / next navigation (ISS-5752).
 *
 ...
 * apps/mobile/CLAUDE.md: pure functions from @orchestra/core are importable).
 */
 ...
 *      that every post-ISS-3130 body persists. Survives a host swap and any
