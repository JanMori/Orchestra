...
/**
 * Kind of a chat message. Additive (ISS-4351): the server always sends a
...
export interface ChatQuickActionsPendingState {
   ...
   * a fresh window each time (ISS-5149 review).
   */
  expires_at: number;
}
 ...
 * even when the message_id repeats (ISS-5149 review).
 */
...
export interface ChatMessage {
   ...
   * produced no text reply (ISS-4351). Optional/additive: absent on older
