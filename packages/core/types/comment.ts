...
// child-done notification, ISS-2538). System rows carry a zero UUID for
...
export interface Comment {
  ...
  // The quick action that produced this comment (ISS-5465). A quick action
  ...
  // Per-target result of every explicit @agent / @crew mention in this comment
  // (ISS-4525 §2). Present only on create/edit responses; older servers omit it.
...
export interface CommentTriggerPreview {
  ...
  // (ISS-4525 §2). Additive: older servers omit it.
