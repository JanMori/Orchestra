/**
 * Issue Quick Actions (ISS-5465) — workspace-level presets for "who to call
...
export type QuickActionAssigneeType = "agent" | "crew";
...
export interface QuickAction {
  ...
  created_at: string;
  updated_at: string;
  /** Display name of the bound agent or crew. Absent when it no longer resolves. */
  target_name?: string;
  /**
  ...
  /** The bound agent or crew was archived or deleted. */
