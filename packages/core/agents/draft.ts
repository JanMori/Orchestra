 ...
 * disagree with what actually ran (ISS-5390).
 */
 ...
 * for the user to pick again — the same rule `orchestra agent copy` already
 * enforces server-side (cmd_agent_copy.go). Before ISS-5390 the fallback kept
 ...
 * concurrency) — mirroring `orchestra agent copy`.
 */
