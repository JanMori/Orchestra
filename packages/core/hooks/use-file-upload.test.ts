...
// ISS-3192 — verifies that the URL chosen for markdown persistence is
...
// ISS-3339 — `uploading` is an in-flight counter, not a single boolean.
...
// is in flight.
describe("useFileUpload — concurrent uploads (ISS-3339 regression)", () => {
