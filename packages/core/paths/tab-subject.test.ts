...
describe("parseTabSubject", () => {
  ...
  const cases: Array<[string, TabSubject]> = [
    ...
    ["/acme/crews", { kind: "page", page: "crews" }],
    ...
    ["/acme/crews/sq1", { kind: "actor", actorType: "crew", id: "sq1" }],
    ...
    ["/acme/inbox?issue=ISS-9", { kind: "inbox", selectedKey: "ISS-9", archived: false }],
    ["/acme/inbox?view=archived", { kind: "inbox", selectedKey: null, archived: true }],
    [
      "/acme/inbox?view=archived&issue=ISS-9",
      { kind: "inbox", selectedKey: "ISS-9", archived: true },
    ],
