...
// One logical Issue-Create draft (ISS-5181), split so switching between the
...
export interface IssueCreateShared {
   ...
   *  only the ids its own content references. Coordinator-owned (ISS-5181 L2):
...
// use the pre-ISS-5181 flat shape. Backfill defaults so every read site can
