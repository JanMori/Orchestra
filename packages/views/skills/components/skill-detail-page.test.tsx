...
import type { Skill } from "@orchestra/core/types";
...
vi.mock("@orchestra/core/permissions", () => ({
  useSkillPermissions: () => ({ canEdit: { allowed: true, reason: null } }),
}));
vi.mock("@orchestra/core/workspace/avatar-url", () => ({
...
vi.mock("@orchestra/ui/components/common/capability-banner", () => ({
...
describe("SkillDetailPage edit action (ISS-5654)", () => {
...
/**
 * ISS-5645. Dirty state is measured against the seeded baseline, not against
 ...
 */
describe("SkillDetailPage draft baseline (ISS-5645)", () => {
