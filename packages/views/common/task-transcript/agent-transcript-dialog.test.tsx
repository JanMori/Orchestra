...
import type { AgentRuntime, AgentTask } from "@orchestra/core/types/agent";
import { useTranscriptViewStore } from "@orchestra/core/agents/stores";
...
vi.mock("@orchestra/ui/lib/clipboard", () => ({
...
vi.mock("@orchestra/ui/components/ui/dropdown-menu", async () => {
...
vi.mock("@orchestra/ui/components/ui/collapsible", async () => {
  const React = await import("react");
