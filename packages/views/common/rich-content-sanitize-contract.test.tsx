/**
 * Cross-surface sanitize contract (ISS-4922).
 *
 ...
 * canonical base from @orchestra/ui/markdown.
 *
...
// still differ. Converging them is the RichCodeBlock phase of ISS-4922; until
