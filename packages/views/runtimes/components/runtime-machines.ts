import { deriveRuntimeHealth, type RuntimeHealth } from "@orchestra/core/runtimes";
...
// the daemon (ISS-4217), so repeating it per runtime is noise — fall back
...
// The custom name shared by every runtime on a machine (ISS-4217). A
