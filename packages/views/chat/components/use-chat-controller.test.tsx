...
import type { Agent, ChatPendingTask, ChatSession, Project } from "@orchestra/core/types";
...
vi.mock("@orchestra/views/issues/components", () => ({ canAssignAgent: () => true }));
...
vi.mock("@orchestra/core/chat/mutations", () => ({
