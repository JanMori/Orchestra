...
/**
 * Inline media re-sign (ISS-3254).
 *
 * Extracted from editor/attachment.tsx so the preview modal can run the same
 * upgrade: gallery navigation (ISS-5752) hands the modal an attachment the
...
import { attachmentIdFromDownloadURL } from "@orchestra/core/types/attachment-url";
...
// auth-gated API path again, and before ISS-5445 the renderer simply kept the
