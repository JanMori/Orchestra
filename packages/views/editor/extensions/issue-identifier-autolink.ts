 ...
 * identifiers (e.g. `TASK-123`) in the editable editor.
 *
 ...
 * the canonical `[TASK-123](mention://issue/<uuid>)`.
 *
...
export interface ResolvedIssueRef {
  /** Issue UUID. */
  id: string;
  /** Canonical identifier as returned by the server, e.g. "TASK-123". */
  identifier: string;
}
...
// detector in @orchestra/ui/markdown.
