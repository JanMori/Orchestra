...
describe("SlashCommandList keyboard handling", () => {
  ...
  // ISS-5495: same Ctrl aliases the command bar (cmdk) accepts, so the slash
  ...
  // ISS-3685: plain Tab accepts the highlighted item like Enter; Shift+Tab and
...
// Async quick-action rendering in the `/` menu (ISS-5465, review finding #4).
//
