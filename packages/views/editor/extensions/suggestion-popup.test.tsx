...
// ---------------------------------------------------------------------------
// Escape containment (ISS-5429): Escape while a picker is open must close ONLY
...
// ---------------------------------------------------------------------------
// Plugin-order guard (ISS-3685): when a suggestion is open inside a list item,
...
// in item 2 for Tab -> sinkListItem to actually fire (Howard, ISS-3685 review):
