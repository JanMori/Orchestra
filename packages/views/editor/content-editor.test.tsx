...
describe("ContentEditor", () => {
  ...
  // document under the new destination (ISS-4864).
  ...
  it("refreshes the live placeholder getter and repaints when the placeholder prop changes", () => {
    // Repro for ISS-4276: Tiptap's Placeholder snapshots a *string* option at
...
// ISS-4808 — the document IS the upload queue, so hosts gate submit off it
// instead of each keeping a counter. These pin the publisher's contract.
describe("ContentEditor — onUploadingChange (ISS-4808)", () => {
...
// ISS-3192 — surfaces like the quick-create modal upload images through the
...
describe("ContentEditor — in-session attachment tracking (ISS-3192)", () => {
