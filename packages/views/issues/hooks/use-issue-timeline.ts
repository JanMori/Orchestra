...
import { sortTimelineEntriesAsc } from "@orchestra/core/issues/timeline-sort";
import {
  unhandledCommentTriggerOutcomes,
  mentionLabelsByTarget,
} from "@orchestra/core/issues/comment-trigger-outcomes";
...
export function useIssueTimeline(issueId: string, userId?: string) {
  ...
  // silent no-op (ISS-4525 §2): the comment IS posted, but N explicitly-named
