...
// Dwell threshold before the activity card opens (ISS-5189).
//
 ...
 * badge alone. Inbox does (ISS-5189): the badge already shows who is running
 ...
 * lists cheap when agents are busy (ISS-4474). 30s staleTime is the offline
 * fallback only.
 */
