...
import type { CommentTriggerPreviewAgent } from "@orchestra/core/types";
...
describe("CommentTriggerChips", () => {
  ...
  it("names a blocked mention with an error reason instead of a count", () => {
    ...
    // gave: invocation_not_allowed also covers an unresolved id (ISS-5548).
    ...
    renderWithI18n(
      <CommentTriggerChips
        ...
        blocked={[
          ...
          { target_type: "crew", target_id: "cafef00d-0002", status: "blocked", reason_code: "runtime_offline" },
        ]}
        draftContent="[@Go](mention://agent/deadbeef-0001) [@Ops](mention://crew/cafef00d-0002)"
        suppressedAgentIds={new Set()}
        onToggle={vi.fn()}
      />,
    );
