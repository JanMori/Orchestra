...
/**
 * AttributionBadge renders who an agent run is accountable to (ISS-4302 §9):
 ...
 * the raw `source` field (ISS-4768).
 *
 * Three shapes, all silent when no responsible member resolved (ISS-4765):
...
export function AttributionBadge({
  ...
  // (ISS-4768). The cautionary tone therefore fires for any non-precise source
