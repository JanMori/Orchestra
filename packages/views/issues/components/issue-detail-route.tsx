...
import { useCanonicalIssue } from "@orchestra/core/issues/canonical-id";
...
interface IssueDetailRouteProps {
   ...
   * human-readable identifier such as `TASK-123`.
   */
  routeId: string;
  onDelete?: () => void;
}
 ...
 * is known, so the address bar and any copied URL read as `TASK-123`.
 *
