...
// Mock @orchestra/views/navigation (AppLink + useNavigation)
vi.mock("../../navigation", () => ({
...
vi.mock("@orchestra/core/issues/stores/view-store", () => ({
...
vi.mock("@orchestra/core/issues/stores/view-store-context", () => ({
...
vi.mock("@orchestra/core/issues/stores/issues-scope-store", () => ({
...
vi.mock("@orchestra/core/issues/stores/selection-store", () => ({
...
vi.mock("@orchestra/core/issues/stores/recent-issues-store", () => ({
