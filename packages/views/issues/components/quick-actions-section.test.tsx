...
import type { QuickAction } from "@orchestra/core/types";
import { renderWithI18n } from "../../test/i18n";
import { QuickActionsSection } from "./quick-actions-section";

// The section's contract (ISS-5465) is mostly about being HONEST with the
...
vi.mock("@orchestra/core/quick-actions", () => ({
