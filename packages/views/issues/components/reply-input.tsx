...
import { SubmitButton } from "@orchestra/ui/components/common/submit-button";
import { ActorAvatar } from "../../common/actor-avatar";
import { contentReferencesAttachment } from "@orchestra/core/types";
import { formatShortcut, useShortcut } from "@orchestra/core/shortcuts";
import { useCommentDraftStore, type CommentDraftKey } from "@orchestra/core/issues/stores";
import { cn } from "@orchestra/ui/lib/utils";
import type { AvatarSize } from "@orchestra/ui/lib/avatar-size";
...
function ReplyInput({
  ...
  // `/` has to offer the same thing here (ISS-5588).
  ...
  // Uploads for this reply session (ISS-5181) — owned by the coordinator. With
