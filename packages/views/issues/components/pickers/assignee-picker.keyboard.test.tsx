...
vi.mock("@orchestra/core/hooks", () => ({ useWorkspaceId: () => "workspace-1" }));
vi.mock("@orchestra/core/auth", () => ({ useAuthStore: () => ({ id: "user-1" }) }));
vi.mock("@orchestra/core/agents", () => ({ isAgentRuntimeBound: () => true }));
