...
import { useCommentComposerStore, useCommentDraftStore } from "@orchestra/core/issues/stores";
...
vi.mock("@orchestra/core/hooks/use-file-upload", async () => ({
  ...(await vi.importActual<typeof import("@orchestra/core/hooks/use-file-upload")>(
    "@orchestra/core/hooks/use-file-upload",
  )),
