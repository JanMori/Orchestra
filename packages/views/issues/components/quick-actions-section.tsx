...
import { dispatchReasonCode } from "@orchestra/core/api";
import { useCurrentWorkspace } from "@orchestra/core/paths";
import { quickActionListOptions, useRunQuickAction } from "@orchestra/core/quick-actions";
import type { Comment, CommentTriggerOutcome, QuickAction } from "@orchestra/core/types";
import { QUICK_ACTION_SIDEBAR_LIMIT } from "@orchestra/core/types";
import {
  AlertDialog,
  AlertDialogAction,
  AlertDialogContent,
...
// Quick Actions sidebar section (ISS-5465).
//
  ...
  const row = (
    <div>
      ...
      >
        ...
        {action.target_name ? (
          <ActorAvatar
            actorType={action.assignee_type === "crew" ? "crew" : "agent"}
