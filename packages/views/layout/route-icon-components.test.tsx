...
import { paths, WORKSPACE_PAGES, DEFAULT_ROUTE_ICON_NAME } from "@orchestra/core/paths";
...
describe("routeIconForPath", () => {
  // The invariant this whole contract exists for (ISS-4370): the sidebar and
  ...
  it("gives a route the same component wherever it is rendered", () => {
    ...
    for (const href of [p.projects(), p.autopilots(), p.chat(), p.crews(), p.usage()]) {
