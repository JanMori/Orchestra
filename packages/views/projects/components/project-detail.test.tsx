...
vi.mock("@orchestra/ui/components/common/emoji-picker", () => ({
  EmojiPicker: () => null,
}));

vi.mock("@orchestra/ui/components/ui/resizable", () => ({
...
vi.mock("@orchestra/ui/components/ui/sheet", () => ({
...
vi.mock("@orchestra/ui/components/ui/alert-dialog", () => ({
  AlertDialog: ({
    open,
    children,
  }: {
