...
import type { Agent, ComposioToolkit } from "@orchestra/core/types";
import { useUpdateAgentAllowlist } from "@orchestra/core/agents";
...
/**
 * Creator-only MCP tab on the agent detail page (ISS-3870). Lets the agent
 ...
 * agent OWNER's Composio connection (ISS-3963) — it is no longer gated on the
...
export function AgentMcpTab({ agent }: { agent: Agent }) {
  ...
  // Composio access warning (ISS-3963). Once an agent is shared, anyone who
