...
import type { AgentActivity } from "@orchestra/core/agents";
import { renderWithI18n } from "../../test/i18n";
import { NavigationProvider, type NavigationAdapter } from "../../navigation";
import { AgentsPage } from "./agents-page";

// These tests pin the `listReady` render gate (ISS-4511): the Agents list must
...
vi.mock("@orchestra/core/agents/stores", () => ({
...
vi.mock("@orchestra/ui/components/ui/skeleton", () => ({
