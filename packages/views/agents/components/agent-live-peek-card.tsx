...
import { issueDetailOptions } from "@orchestra/core/issues";
...
// crew members tab cares about (workload, current issue, last activity).
...
function CurrentIssueRow({
  ...
  // resolves the human identifier (TASK-123) + title.
