...
// borrow this entry's levels — that's the ISS-4347 fix.
...
describe("ThinkingPropRow", () => {
  ...
  it("hides the picker for an empty codex model — it must not borrow the Default's catalog (ISS-4347)", async () => {
