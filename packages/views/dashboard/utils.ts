...
// refuses to name (ISS-5409): agents the viewer may not see, plus the hidden
...
//
// ISS-3771 (PR #4637) originally *dropped* these rows so they'd stop rendering
...
// per-agent breakdown no longer reconciled with the totals (ISS-3776, #4640).
...
// `@orchestra/core/dashboard`; the raw reason survives only in
...
// serializing (ISS-5409), because client-side filtering is decoration — one
