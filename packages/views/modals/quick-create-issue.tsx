...
import { DialogTitle } from "@orchestra/ui/components/ui/dialog";
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
...
} from "@orchestra/core/issues/stores/quick-create-store";
import {
...
export function AgentCreatePanel({
  ...
  // (see PR #1851 / ISS-1496). Pre-check on the picker so the user gets
  ...
  // Coordinator-owned uploads in the shared draft pool (ISS-5181, L2): a file
