...
import { larkInstallationsOptions, larkKeys } from "@orchestra/core/lark";
import { api, ApiError } from "@orchestra/core/api";
import type { LarkInstallation, LarkInstallStatusResponse } from "@orchestra/core/types";
import { ActorAvatar } from "../../common/actor-avatar";
import { useT } from "../../i18n";

// ISS-3083: the Lark (international, open.larksuite.com) "connect a Bot"
...
//      owner/admin; see server/internal/handler/lark.go, ISS-4213), so
...
export function LarkAgentBindButton({
   ...
   * canManageAgent authorization (ISS-4213). Omit it to keep the button
   * workspace owner/admin-only.
   */
  ...
  // workspace owner/admin may bind/manage the bot (ISS-4213).
  ...
  // which has surfaced as confusing for international users (ISS-3083
  ...
  return (
    <>
      ...
      >
        ...
        {/* ISS-3083: Lark (international) bind entry is temporarily hidden —
...
// backend authorizes DELETE with the same canManageAgent check (ISS-4213)
