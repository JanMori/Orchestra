...
vi.mock("@orchestra/ui/components/common/theme-provider", () => ({
  useTheme: () => ({ theme: "light", setTheme: mockSetTheme }),
}));

vi.mock("@orchestra/core/i18n/react", async () => {
  const actual =
    await vi.importActual<typeof import("@orchestra/core/i18n/react")>(
      "@orchestra/core/i18n/react",
    );
  return {
    ...actual,
    useLocaleAdapter: () => ({
...
import { useCommentComposerStore } from "@orchestra/core/issues/stores";
...
describe("PreferencesTab — Timezone section", () => {
  ...
  // slow CI runners (ISS-4427). Everything these tests pick — Asia/Tokyo
