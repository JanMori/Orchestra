...
} from "@orchestra/core/composio";
import type { ComposioToolkit } from "@orchestra/core/types";
...
//
// Key UX rule (ISS-4009): the backend only returns toolkits with an enabled
...
export function ComposioTab() {
  ...
  // Service.CallbackRedirect, ISS-3720). Consume it exactly once: fire a toast,
  ...
  // (ISS-3719) lands, but the branch is wired up now so it lights up for free.
  ...
  // stamping it (Stage 3, ISS-3721); the card shows a "never used" placeholder
  // until then.
