...
// ApiError is re-exported from @orchestra/core/api; we mock the api module
...
describe("LarkAgentBindButton (CTA gate)", () => {
  ...
  it("shows the Feishu bind CTA but hides the Lark CTA for an owner (ISS-3083)", () => {
    ...
    // install→inbound pipeline is stabilized (ISS-3083).
  ...
  it("shows the Feishu bind CTA but hides the Lark CTA for an admin (ISS-3083)", () => {
  ...
  it("shows the Feishu bind CTA for a non-admin agent owner (agentOwnerId matches the user, ISS-4213)", () => {
  ...
  // NOTE (ISS-3083): the "clicking Bind to Lark begins an install with
  ...
  it("shows the Feishu CTA (Lark hidden) for an agent without its own installation, per-agent scoping (ISS-3083)", () => {
    installationsRef.current.installations = [
      {
        id: "inst-other",
        workspace_id: "ws-1",
  ...
  it("shows the Feishu CTA (Lark hidden) when this agent's only installation is revoked (ISS-3083)", () => {
    installationsRef.current.installations = [
      {
        id: "inst-revoked",
        workspace_id: "ws-1",
...
describe("LarkInstallDialog (polling terminal errors)", () => {
  ...
  async function openDialog() {
    ...
    // The Lark CTA is hidden (ISS-3083); open the dialog via the Feishu CTA
  ...
  it("renders the QR after a React StrictMode double-mount (regression for empty dialog body)", async () => {
    ...
    // The Lark CTA is hidden (ISS-3083); the StrictMode regression is about
